...
Question 3: Which state has the largest number of individuals affected by data breaches? What type of data breach was dominant?
Graph: Bar Chart
Question 4: Is there a correlation between the type of breach and the device that was breached?
Graph: Mosaic chart
Question 5: Is there a correlation between the type of breach and the number of indiviuals effected?
Graph: Bar Chart

Question 6: do healthcare facilities account for more than 50% of the data breaches in the data set? And is there a relationship between the businesses that have hosipital, health, or medical in the name and individuals affected?
